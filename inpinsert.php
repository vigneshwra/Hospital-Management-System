...
$admittype= stripslashes($admittype);
$admittype = mysqli_real_escape_string($conn,$admittype);
$governins=$_POST['insurance'];
$governins= stripslashes($governins);
$governins = mysqli_real_escape_string($conn,$governins);
$otherpolicy= mysqli_real_escape_string($conn,$_POST['otherpolicy']);
$policynum= mysqli_real_escape_string($conn,$_POST['policynum']);
$policydate= mysqli_real_escape_string($conn,$_POST['policydate']);
...
$sql = ("INSERT INTO inpatient(hospitalname,enroll,doctor,attender,intime,admittype,governins,otherpolicy,policynumber,policydate,history,cheif1,cheif2,outtime,height,weight,temperature,pulse,respiratory,issues1,issues2,issues3,common1,common2,common3,physical1,physical2,physical3,clinical1,clinical2,clinical3,aadhar,firstname,gender,phone,dob,blood,age,mode) VALUES ('$hospitalname','$datevisited','$doctorname','$attendername','$intime','$admittype','$governins','$otherpolicy','$policynum','$policydate','$history','$cheif1','$cheif2','$outtime','$height','$weight','$temperature','$pulserate','$respiratory','$issue1','$issue2','$issue3','$common1','$common2','$common3','$physical1','$physical2','$physical3','$clinical1','$clinical2','$clinical3','$aadhar','$firstname','$gender','$phone','$dob','$blood','$age','$mode')");
