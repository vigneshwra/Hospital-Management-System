...
<div id="contact-form" class="clearfix">
    ...
    <h1>Patient Record - OUT PATIENT</h1>
    <form method="post" action="opinsert.php" name="myforms" onsubmit="return validateFunction()">
...
<label for="name"> Temperature: (deg C)</label>
	...
	<label for="name"> Issues: </label>	
		...
		<label for="name">Aadhar Card Number: </label></label>
        ...
        <input type="text" id="name" name="mpname" value="Out patient"  required="required" autofocus="autofocus" />
		</div>
		</div>
